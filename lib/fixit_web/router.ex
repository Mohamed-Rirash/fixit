defmodule FixitWeb.Router do
  use FixitWeb, :router

  import FixitWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {FixitWeb.Layouts, :root}
  ...
  # scope "/api", FixitWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:fixit, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: FixitWeb.Telemetry
  ...
  scope "/", FixitWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{FixitWeb.UserAuth, :require_authenticated}] do
  ...
  scope "/", FixitWeb do
    ...
    live_session :current_user,
      on_mount: [{FixitWeb.UserAuth, :mount_current_scope}] do
