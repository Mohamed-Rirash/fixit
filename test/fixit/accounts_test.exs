defmodule Fixit.AccountsTest do
  use Fixit.DataCase

  alias Fixit.Accounts

  import Fixit.AccountsFixtures
  alias Fixit.Accounts.{User, UserToken}
  ...
  describe "get_user_by_email_and_password/2" do
    ...
    test "does not return unconfirmed users" do
  ...
  describe "register_user/1" do
    test "requires first name, last name, email, and password to be set" do
    ...
    test "registers users with profile details and password" do
  ...
  describe "login_user_by_magic_link/1" do
    ...
    test "confirms unconfirmed user with password set" do
      user = unconfirmed_user_fixture()
      {1, nil} = Repo.update_all(User, set: [hashed_password: "hashed", confirmed_at: nil])
      {encoded_token, _hashed_token} = generate_user_magic_link_token(user)
